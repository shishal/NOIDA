...
ALTER TABLE `noida`.`amc` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`asset_detail` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`asset_issue_detail` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`asset_main_type` 
CHANGE COLUMN `DESC` `DESCRIPTION` VARCHAR(500) NULL DEFAULT NULL ,
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`asset_sub_type` 
CHANGE COLUMN `DESC` `DESCRIPTION` VARCHAR(500) NULL DEFAULT NULL ,
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`department` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`po` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`request_detail` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`request_history` 
CHANGE COLUMN `DESC` `DESCRIPTION` VARCHAR(500) NULL DEFAULT NULL ,
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `DESCRIPTION`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`user_roles` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `ROLE`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;

ALTER TABLE `noida`.`users` 
ADD COLUMN `CREATED_TIME` DATETIME NULL AFTER `CONTACT_NO`,
ADD COLUMN `UPDATED_TIME` DATETIME NULL AFTER `CREATED_TIME`;
