...
<!-- <div class="pane-content bg-alt">
	...
	<div class="row">
		...
		<a href="#"><span title="Add New AMC" style="font-size:20px;" class="hidden-xs showopacity glyphicon glyphicon-plus"></span></a>
		&nbsp;&nbsp;
		<a href="#"><span title="Edit selected AMC" style="font-size:20px;" class="hidden-xs showopacity glyphicon glyphicon-edit"></span></a>
		&nbsp;&nbsp;
		<a href="#"><span title="Export" style="font-size:20px;" class="hidden-xs showopacity glyphicon glyphicon-export"></span></a>
		&nbsp;&nbsp;
		<a href="#"><span title="Delete selected AMC" style="font-size:20px;" class="hidden-xs showopacity glyphicon glyphicon-trash"></span></a>
		&nbsp;&nbsp;
  ...
  <form class="form-inline" style="padding-left:2%">
    <div class="form-group">
      <label for="poNumber">AMC Number</label>
    ...
    <button type="submit" class="btn btn-primary">Search</button>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					<th scope="row">1</th>
					<td><button type="button" class="btn btn-link" data-toggle="modal" data-target="#AMCDetails">ABC123</button></td>
					<td>Samsung</td>
					<td>20-June-2016</td>
				</tr>
				<tr>
					<th scope="row">2</th>
					<td><button type="button" class="btn btn-link" data-toggle="modal" data-target="#AMCDetails">DEF123</button></td>
					<td>HP</td>
					<td>20-June-2016</td>
				</tr>
			</tbody>
		...
		<div class="modal fade page-normal-font" id="AMCDetails" tabindex="-1" role="dialog" 
                ...
                <form role="form">
                  ...
                  <div class="form-group">
                    <label for="inputVendor">Vendor: </label>
                      ...
                      id="inputVendor" disabled="disabled"/>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="inputDesc">Description: </label>
                      <input type="text" class="form-control" value="AMC for 4 months"
