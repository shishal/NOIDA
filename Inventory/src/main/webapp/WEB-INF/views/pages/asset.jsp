...
<div class="row">
	...
	<div class="col-md-6 text-right"
		...
		<a href="#"><span title="Add New Asset" style="font-size: 20px;"
			data-toggle="modal" data-target="#addNewAsset"
			class="hidden-xs showopacity glyphicon glyphicon-plus"></span></a>
		&nbsp;&nbsp; <a href="#"><span title="Edit selected Asset"
			style="font-size: 20px;" data-toggle="modal"
			data-target="#addNewAsset"
		...
		&nbsp;&nbsp; <a href="#"><span title="Delete selected Asset"
			style="font-size: 20px;"
...
<form class="form-inline" style="padding-left: 2%">
	<div class="form-group">
		<label for="inputBarCode">Asset BarCode</label> <input type="text"
	...
	<div class="form-group">
		<label for="inputPONumber">PO Number</label> <input type="text"
			class="form-control" id="inputPONumber">
	</div>

	<div class="form-group">
		<label for="inputAMCNumber">AMC Number</label> <input type="text"
			class="form-control" id="inputAMCNumber">
	</div>

	<div class="form-group">
		<label for="inputAssignedUser">Assigned User</label> <input
			type="text" class="form-control" id="inputAssignedUser">
	</div>
